...
read and even more to understand. I have found myself recently and regularly discussing a few topics associated with
[OpenID Connect 1.0] and in particular some of the nuances that are not well understood in my opinion. These topics are
technical ones, but they are important and fundamental concepts that it seems a lot of people don't put time into
understanding when they implement this technology.
...
I understand most people will find this topic rather boring, but those of you who find technical articles interesting
will probably really like this, especially if your understanding of the specifications is non-existent or just starting
to develop.
...
It can contain more, and in some scenarios it should contain a lot of [Claims]. The section on
[Requesting Claims using Scope Values] has one crucial passage:
